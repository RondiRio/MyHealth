                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-6">
                            <div class="card-body p-4 p-lg-5">
                                ...
                                <form action="../controller/Valida_login.php" method="POST" autocomplete="off">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" id="identificador" name="identificador" class="form-control" value="" required placeholder="CRM ou CPF">
